 ...
 * @author l.xue.nong
 */
public class WebFailUserContextFilter extends OncePerRequestFilter implements Filter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (httpSession != null) {
			...
			if (sessionId != null) {
				OnlineSysUserEntity onlineSysUserEntity = WebUserService.getFail(sessionId);
