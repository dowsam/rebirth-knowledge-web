    ...
    <div class="bianji">
        <div class="bianji_con">
        	<div class="bianji_tit">
                ...
                <div class="clear"></div>
                <ul class="t1">
                	<li class="t1_tit"><span>视频名称：</span><input type="text" /></li>
                    <li class="t1_quanxian"><span>观看权限：</span><select><option>公众公开</option><option>社区公开</option><option>企业公开</option><option>好友公开</option><option>密友公开</option><option>私有</option></select><div><input type="checkbox" />原创投稿</div><div class="nav_quanxian"><select><option>书柜分类</option><option>生 活</option><option>学 习</option><option>娱 乐</option><option>其 他</option></select><ul><li><a>编辑分类</a></li></ul></div></li>
                    <li class="t1_biaoq"><span>视频标签：</span><input type="text" /><div>博文摘要:<a href="#">添加文章摘要</a>(选填)</div></li>
                </ul>
            </div>	
            <div class="clear"></div>
            <div class="spms">
                ...
                <ul>
                    ...
                    <li><a href="#" id="spshousuo"><img src="${path }images/ss.png" /></a></li>
                </ul>
                <div class="spbj_tj">
                	<h2>添加视频<a href="#">&nbsp;</a></h2>
                    <ul class="ta">
                    ...
                    <ul id="ta2">
                    	<li class="spbj_tj_con" style="display:block">
                        	<ul>
                            	<li><span>视频名称:</span><input type="text" /></li>
                                <li><span>主员名称:</span><input type="text" /></li>
                ...
                <table>
                  <tr>
                    <td class="tab_tit">名称/评论/大小</td>
                    <td style="width:120px" class="tab_tit">主演</td>
                  </tr>
                  <tr>
                    <td>
                        <input type="checkbox" />
                        <a href="#">视频编辑视频编辑视频编辑视频编辑视频编辑视频编辑视频编辑视频编辑视频编辑</a>
                        <span>小心许三多/700MB</span>
                    </td>
                    <td>张三李四</td>
                  </tr>
                  <tr>
