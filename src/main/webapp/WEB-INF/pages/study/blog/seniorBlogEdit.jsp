        ...
        <div class="bianji_con">
        	<div class="bianji_tit">
            	<ul class="t0">
                    ...
                    <li style="margin-top:12px"><a href="${path }study/blog/new">返回普通编辑</a></li>
                </ul>
                <div class="clear"></div>
                <ul class="t1">
            ...
            <div class="bj_c">
            	<ul>
                	<li><div class="c_li">
                        <h2><a href="#">可选包资费标准。</a></h2>
                      <div class="clear">
                            <ul>
                                <li><a href="#">中国电信福建公司中国电信福建公司</a></li>
                                <li><a href="#">中国电信福建公司中国电信福建公司</a></li>
                                <li><a href="#">中国电信福建公司中国电信福建公司</a></li>
                            </ul>
                            <div class="panr">
                                <a href="#" class="part">编辑</a>
                                <ul>
                                	<li style="border-bottom:none;" class="activ5"><a href="#">添加子块</a></li>
                                    <li style="border-top:none;"><a href="#">添加 同级块</a></li>
                                    <li><a href="#">编辑标题</a></li>
                                    <li><a href="#">编辑内容</a></li>
                                    <li><a href="#">删除</a></li>
                                    <li><a href="#">上移</a></li>
